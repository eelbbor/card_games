...
public class Deck {
    ...
    /**
     * Creates a deck of cards based on the provided {@link List} of cards. The list must be
     ...
     *
     * @return {@link Optional<Card>} on the top of the discard stack unless empty.
     */
     ...
     *
     * @return {@link Optional<Card>} from the top of the discard stack unless empty.
     */
