...
public class Hand {
    ...
    /**
     * Removes the card if it is present in the hand. Unopinionated method does not throw exception
     * if the card is not in the hand. Use the return value to indicate if the card was played.
     *
