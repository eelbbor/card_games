...
/**
 * Standard face values for a traditional set of French playing cards. The unicode offsets skip the
 * Knights, which would come between the Queen and King in some countries decks. Note: The default
 * sort order for the enum will yield the Ace high due to ordinals.
 *
